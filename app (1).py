...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Bạch - Trường Tiểu học Minh Quang - ĐT: 038 9096 938</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Bạch - Trường Tiểu học Minh Quang - ĐT: 038 9096 938</div>", unsafe_allow_html=True)
